...
cd /d %~dp0
cd /d .\bin\
.\ffmpeg -user_agent "Mozilla/5.0 (Macintosh; Intel Mac OS X 11_1_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.182 Safari/537.36" -headers referer:%header% -i %input% -c copy ..\download\%output%
